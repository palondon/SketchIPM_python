...
import ipm_func
import svm_func
from parameters import m,w,n,p,gamma,sigma_step,sigma,t_iter,tol_cg, MAXIT_cg, DENSITY
#------------------------------------------------------------
...
if __name__ == '__main__':
	...
	plt.figure(0)
	plt.plot(range(iter_out_stan), iter_in_cg_vec_stan, colors[0], label='Stand. IPM', markersize=8)
	plt.plot(range(iter_out_ipm), iter_in_cg_vec_ipm, colors[1], label='Sketch IPM', markersize=8)
	...
	# 1 - kappa
	plt.figure(0)
	plt.semilogy(range(iter_out_stan), kap_AD_vec, colors[0], label='Stand. IPM', markersize=8)
	...
	# 2 - v
	plt.figure(0)
	plt.plot(range(iter_out_stan), v_vec, colors[0], markersize=8)
	plt.plot(range(iter_out_ipm), iter_in_cg_vec_ipm, colors[1], label='Sketch IPM', markersize=8)
